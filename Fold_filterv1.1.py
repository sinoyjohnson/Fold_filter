...
def filter_deg_results(input_file, output_prefix, log2fc_cutoff, pvalue_cutoff, tool,
                       ...
                       use_adjusted_pvalue=False, remove_duplicates=False):
    """
    ...
    Args:
        ...
        remove_duplicates (bool, optional): If True, remove duplicate transcripts from the filtered results, keeping the best one.
    """
    ...
    if remove_duplicates and not filtered_df.empty:
        logger.info("Removing duplicate transcript IDs...")
        ...
        logger.warning("No duplicates to remove as the filtered DataFrame is empty.")
...
def main():
    ...
    parser.add_argument("--remove_duplicates", action="store_true", help="Remove duplicate transcript IDs, keeping the entry with the best p-value/log2FC.")
    ...
    filter_deg_results(args.input_file, args.output_prefix, args.log2fc, args.pvalue, args.tool,
                       ...
                       args.use_adjusted_pvalue, args.remove_duplicates)
